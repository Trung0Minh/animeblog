    ...
    <div className="min-h-screen">
      <header className="border-b bg-background/95">
        <div className="container flex h-14 items-center">
          <span className="text-sm font-bold tracking-tight">Anime Blog</span>
        </div>
      </header>
      ...
      <main className="container py-16 sm:py-24">
        <section className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl font-serif text-lg leading-relaxed text-muted-foreground">
            In-depth analysis, production insight, interviews, and reviews in
            an editorial space designed for comfortable long-form reading.
          </p>
        </section>
